...
### Encapsulation
Mechanism of wrapping the data (variable) and the code (method) that manipulate the data into a single unit called class, it is the way to achieve data hiding.
